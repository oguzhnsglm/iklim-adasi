...
export default function OceanMascot({
  size = 64,
  mood = "idle",
  idleAfterMs = 60000,
  activityKey,
  ...
  const currentMood: MascotMood = sleepActive ? "sleepy" : greetPlaying ? "greet" : mood;
  ...
  const moodRef = useRef<MascotMood>(currentMood);
  const lastMoodRef = useRef<MascotMood>(mood);
  ...
  const fins = useMemo(() => {
    ...
    for (let i = 0; i < count; i += 1) {
      ...
      items.push(
        <G key={`fin-${i}`} rotation={rotate} origin="100,100">
          <Ellipse
            cx="100"
            cy={34}
            rx={16 * widJ}
    ...
    >
      <View style={{ width: size, height: size }}>
        <Svg width={size} height={size} viewBox="0 0 200 200">
          <Defs>
            <RadialGradient id="fishBody" cx="46%" cy="34%" r="70%">
              <Stop offset="0" stopColor="#CFF3F5" />
              <Stop offset="0.6" stopColor="#7FD3DB" />
              <Stop offset="1" stopColor="#4FB4C4" />
            </RadialGradient>
            <LinearGradient id="bodyShade" x1="0" y1="0" x2="0" y2="1">
              <Stop offset="0" stopColor="#000000" stopOpacity="0" />
              <Stop offset="1" stopColor="#0B3D45" stopOpacity="0.18" />
            </LinearGradient>

            <LinearGradient id="finMain" x1="0" y1="0" x2="0" y2="1">
              <Stop offset="0" stopColor="#D9F6F7" />
              <Stop offset="1" stopColor="#8FDDE6" />
            </LinearGradient>
            <LinearGradient id="finShade" x1="0" y1="0" x2="0" y2="1">
              <Stop offset="0" stopColor="#000000" stopOpacity="0" />
              <Stop offset="1" stopColor="#1F5F6B" stopOpacity="0.22" />
            </LinearGradient>
          ...
          >
            ...
            <Ellipse cx="100" cy="102" rx="72" ry="62" fill="url(#fishBody)" />
            <Path
              d="M44 130 C62 160 138 160 156 130 C150 158 124 172 100 174 C76 172 50 158 44 130 Z"
              fill="url(#bodyShade)"
              opacity={0.24}
            />
            <Path
              d="M60 56 C78 36 122 36 140 58 C122 48 98 46 70 54 Z"
              fill="#FFFFFF"
              opacity="0.12"
            />

            <Path
              d="M165 98 C182 92 190 106 182 120 C176 130 162 132 152 124 C158 116 162 108 165 98 Z"
              fill="#8FDDE6"
            />
            <Path
              d="M160 100 C174 96 178 108 170 118 C166 124 158 126 152 122 C156 114 158 108 160 100 Z"
              fill="#6FC9D3"
              opacity={0.7}
            />
